...
// Initialise the shared lookup tables. DOSBox called this from Handler::Init;
// standalone users must call it once before creating any Chip.
void InitTables( void );

#if !defined(DBOPL_STANDALONE)
