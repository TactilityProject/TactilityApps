...
// Implemented in DoomEsp.cpp - signals the doom loop's worker task to exit, so
// choosing "Quit" from the in-game menu closes the app the same way touch-to-exit does.
extern void doomEsp_RequestStop(void);
